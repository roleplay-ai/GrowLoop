...
export const metadata: Metadata = { title: 'Skills Library' }

export default function AdminSkillsPage() {
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <Topbar title="Skills Library" />
      <main className="flex-1 overflow-y-auto p-6">
        <div className="max-w-2xl mx-auto">
          <div className="nudge-card rounded-xl p-12 text-center">
            <div className="text-6xl mb-4">🧠</div>
            <h2 className="text-xl font-bold text-brand-dark mb-2">Skills Library</h2>
            <p className="text-sm text-muted-foreground mb-4">
              Manage platform-wide skills, dimensions, and rubrics.
            </p>
